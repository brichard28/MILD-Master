...
curr_subject_ID = char('mild_master_25',...
    'mild_master_26',...
    'mild_master_27',...
    'mild_master_28',...
    'mild_master_30',...
...
for isubject = 1:size(curr_subject_ID,1)
    ...
    save(append('Results_Subject_',strtrim(string(curr_subject_ID(isubject,:))),'.mat'),'data_by_pair_onset_baselined','data_by_button_press_baselined','ERP_info_button_press','ERP_info','-v7.3')
