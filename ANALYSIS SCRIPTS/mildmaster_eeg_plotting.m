...
subplot(1,4,1) % ITD50
hold on
this_lead_data = squeeze(mean(itd50_by_lead_target_onset(:,frontocentral_channels,:),2));
this_lag_data = squeeze(mean(itd50_by_lag_target_onset(:,frontocentral_channels,:),2));
...
hold on
this_lead_data = squeeze(mean(itd500_by_lead_target_onset(:,frontocentral_channels,:),2));
this_lag_data = squeeze(mean(itd500_by_lag_target_onset(:,frontocentral_channels,:),2));
shadedErrorBar(single_onset_time,mean(this_lead_data,1),std(this_lead_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-r'})
shadedErrorBar(single_onset_time,mean(this_lag_data,1),std(this_lag_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-b'})
ylim([-3.5,3.5])
xlim([erp_window_start_time,erp_window_end_time - 250])
...
subplot(1,4,3) % ILD5
hold on
this_lead_data = squeeze(mean(ild5_by_lead_target_onset(:,frontocentral_channels,:),2));
this_lag_data = squeeze(mean(ild5_by_lag_target_onset(:,frontocentral_channels,:),2));
shadedErrorBar(single_onset_time,mean(this_lead_data,1),std(this_lead_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-r'})
shadedErrorBar(single_onset_time,mean(this_lag_data,1),std(this_lag_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-b'})
ylim([-3.5,3.5])
xlim([erp_window_start_time,erp_window_end_time - 250])
...
hold on
this_lead_data = squeeze(mean(ild5mag_by_lead_target_onset(:,frontocentral_channels,:),2));
this_lag_data = squeeze(mean(ild5mag_by_lag_target_onset(:,frontocentral_channels,:),2));
shadedErrorBar(single_onset_time,mean(this_lead_data,1),std(this_lead_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-r'})
shadedErrorBar(single_onset_time,mean(this_lag_data,1),std(this_lag_data,[],1)./(sqrt(num_subjects - 1)),'lineProps',{'-b'})
ylim([-3.5,3.5])
xlim([erp_window_start_time,erp_window_end_time - 250])
