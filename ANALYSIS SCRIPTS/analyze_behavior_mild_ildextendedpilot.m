...
subject_ID = char('eeg_pilot_2','eeg_pilot_3'); % neuroimaging pilot
num_conditions = 8;
min_click_times = [];
all_click_times = [];
...
all_maskers = {'side=r_itd=0_az=20_mag=0_lpf=0',...
...
p1 = errorbar(1:2:4,mean(d_primes_collapsed(1:2:4,:),2),std(d_primes_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(d_primes_collapsed(2:2:4,:),2),std(d_primes_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylabel("d'",'FontSize',18)
ylim([0 7])
xticks(1:4)
xticklabels({'20deg','20degMag','5deg','5degMag'})
%xlabel('ITD (us)')
...
p1 = errorbar(1:2:4,mean(all_hit_rates_collapsed(1:2:4,:),2),std(all_hit_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_hit_rates_collapsed(2:2:4,:),2),std(all_hit_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
...
p1 = errorbar(1:2:4,mean(all_FA_rates_collapsed(1:2:4,:),2),std(all_FA_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_FA_rates_collapsed(2:2:4,:),2),std(all_FA_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
...
p1 = errorbar(1:2:4,mean(lead_d_primes_collapsed(1:2:4,:),2),std(lead_d_primes_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(lead_d_primes_collapsed(2:2:4,:),2),std(lead_d_primes_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
xticks(1:4)
ylim([0 7])
ylabel("d'",'FontSize',18)
xticklabels({'20deg','20degMag','5deg','5degMag'})
...
p1 = errorbar(1:2:4,mean(lag_d_primes_collapsed(1:2:4,:),2),std(lag_d_primes_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(lag_d_primes_collapsed(2:2:4,:),2),std(lag_d_primes_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
xticks(1:4)
ylabel("d'",'FontSize',18)
xticklabels({'20deg','20degMag','5deg','5degMag'})
%xlabel('ITD (us)')
...
p1 = errorbar(1:2:4,mean(all_lead_hit_rates_collapsed(1:2:4,:),2),std(all_lead_hit_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_lead_hit_rates_collapsed(2:2:4,:),2),std(all_lead_hit_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel("Hit Rate",'FontSize',18)
xticks(1:4)
xticklabels({'20deg','20degMag','5deg','5degMag'})
...
p1 = errorbar(1:2:4,mean(all_lag_hit_rates_collapsed(1:2:4,:),2),std(all_lag_hit_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_lag_hit_rates_collapsed(2:2:4,:),2),std(all_lag_hit_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel("Hit Rate",'FontSize',18)
xticks(1:4)
xticklabels({'20deg','20degMag','5deg','5degMag'})
...
p1 = errorbar(1:2:4,mean(all_lead_FA_rates_collapsed(1:2:4,:),2),std(all_lead_FA_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_lead_FA_rates_collapsed(2:2:4,:),2),std(all_lead_FA_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel("FA Rate",'FontSize',18)
xticks(1:4)
xticklabels({'20deg','20degMag','5deg','5degMag'})
...
p1 = errorbar(1:2:4,mean(all_lag_FA_rates_collapsed(1:2:4,:),2),std(all_lag_FA_rates_collapsed(1:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:4,mean(all_lag_FA_rates_collapsed(2:2:4,:),2),std(all_lag_FA_rates_collapsed(2:2:4,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel("FA Rate",'FontSize',18)
xticks(1:4)
xticklabels({'20deg','20degMag','5deg','5degMag'})
