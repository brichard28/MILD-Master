...
subject_ID = char('lpfpilot3','lpfpilot4','lpfpilot5','lpfpilot7','lpfpilot8'); % ild pilot % ,'shorttest4'
num_conditions = 16;
min_click_times = [];
all_click_times = [];
...
all_maskers = {'side=r_itd=0_az=5_mag=0_lpf=0',...
'side=l_itd=0_az=5_mag=0_lpf=0',...
'side=r_itd=0_az=5_mag=1_lpf=0',...
'side=l_itd=0_az=5_mag=1_lpf=0',...
'side=r_itd=0_az=10_mag=0_lpf=0',...
'side=l_itd=0_az=10_mag=0_lpf=0',...
'side=r_itd=0_az=10_mag=1_lpf=0',...
'side=l_itd=0_az=10_mag=1_lpf=0',...
'side=r_itd=0_az=5_mag=0_lpf=1',...
'side=l_itd=0_az=5_mag=0_lpf=1',...
'side=r_itd=0_az=5_mag=1_lpf=1',...
'side=l_itd=0_az=5_mag=1_lpf=1',...
'side=r_itd=0_az=10_mag=0_lpf=1',...
'side=l_itd=0_az=10_mag=0_lpf=1',...
'side=r_itd=0_az=10_mag=1_lpf=1',...
'side=l_itd=0_az=10_mag=1_lpf=1'};
...
%         end
       ...
       threshold_window_start = 0.05; %0.2
       threshold_window_end =  0.6; % 1.15
       tVec = 0:1/44100:10;
...
all_hits_collapsed_left_and_right(7,:) = sum(all_hits(:,[13,14]),2); % itd400 / ild60mag
all_hits_collapsed_left_and_right(8,:) = sum(all_hits(:,[15,16]),2); % itd50 / ild10
...
all_lead_hits_collapsed_left_and_right(7,:) = sum(all_lead_hits(:,[13,14]),2); % itd400 / ild60mag
all_lead_hits_collapsed_left_and_right(8,:) = sum(all_lead_hits(:,[15,16]),2); % itd50 / ild10
...
all_lag_hits_collapsed_left_and_right(7,:) = sum(all_lag_hits(:,[13,14]),2); % itd400 / ild60mag
all_lag_hits_collapsed_left_and_right(8,:) = sum(all_lag_hits(:,[15,16]),2); % itd50 / ild10
...
all_FAs_collapsed_left_and_right(7,:) = sum(all_FAs(:,[13,14]),2); % itd400 / ild60mag
all_FAs_collapsed_left_and_right(8,:) = sum(all_FAs(:,[15,16]),2); % itd50 / ild10
...
all_lead_FAs_collapsed_left_and_right(7,:) = sum(all_lead_FAs(:,[13,14]),2); % itd400 / ild60mag
all_lead_FAs_collapsed_left_and_right(8,:) = sum(all_lead_FAs(:,[15,16]),2); % itd50 / ild10
...
all_lag_FAs_collapsed_left_and_right(7,:) = sum(all_lag_FAs(:,[13,14]),2); % itd400 / ild60mag
all_lag_FAs_collapsed_left_and_right(8,:) = sum(all_lag_FAs(:,[15,16]),2); % itd50 / ild10
...
all_num_target_bash_collapsed_left_and_right(8,:) = sum(all_num_target_bash(:,[15,16]),2); % itd200 /ild60
...
all_num_lead_target_bash_collapsed_left_and_right(8,:) = sum(all_num_lead_target_bash(:,[15,16]),2); % itd200 /ild60
...
all_num_lag_target_bash_collapsed_left_and_right(8,:) = sum(all_num_lag_target_bash(:,[15,16]),2); % itd200 /ild60
...
all_num_masker_bash_collapsed_left_and_right(8,:) = sum(all_num_masker_bash(:,[15,16]),2); % itd200 /ild60
...
all_num_lead_masker_bash_collapsed_left_and_right(8,:) = sum(all_num_lead_masker_bash(:,[15,16]),2); % itd200 /ild60
...
all_num_lag_masker_bash_collapsed_left_and_right(8,:) = sum(all_num_lag_masker_bash(:,[15,16]),2); % itd200 /ild60
...
d_primes_collapsed(7,:) = mean(d_primes_all(:,[13,14]),2); % itd50 / ild10
d_primes_collapsed(8,:) = mean(d_primes_all(:,[15,16]),2); % itd100 / ild10mag
...
lead_d_primes_collapsed(7,:) = mean(lead_d_primes_all(:,[13,14]),2); % itlead_d50 / illead_d10
lead_d_primes_collapsed(8,:) = mean(lead_d_primes_all(:,[15,16]),2); % itlead_d100 / illead_d10mag
...
lag_d_primes_collapsed(7,:) = mean(lag_d_primes_all(:,[13,14]),2); % itlag_d50 / illag_d10
lag_d_primes_collapsed(8,:) = mean(lag_d_primes_all(:,[15,16]),2); % itlag_d100 / illag_d10mag
...
p1 = errorbar(1:2:8,mean(d_primes_collapsed(1:2:8,:),2),std(d_primes_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(d_primes_collapsed(2:2:8,:),2),std(d_primes_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylabel("d'")
ylim([0 7])
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
%xlabel('ITD (us)')
...
p1 = errorbar(1:2:8,mean(all_hit_rates_collapsed(1:2:8,:),2),std(all_hit_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(all_hit_rates_collapsed(2:2:8,:),2),std(all_hit_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel('Hit Rate')
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
...
p1 = errorbar(1:2:8,mean(all_FA_rates_collapsed(1:2:8,:),2),std(all_FA_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(all_FA_rates_collapsed(2:2:8,:),2),std(all_FA_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
ylabel('FA Rate')
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
...
p1 = errorbar(1:2:8,mean(lead_d_primes_collapsed(1:2:8,:),2),std(lead_d_primes_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(lead_d_primes_collapsed(2:2:8,:),2),std(lead_d_primes_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
xticks(1:8)
ylim([0 7])
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
%xlabel('ITD (us)')
...
p1 = errorbar(1:2:8,mean(lag_d_primes_collapsed(1:2:8,:),2),std(lag_d_primes_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(lag_d_primes_collapsed(2:2:8,:),2),std(lag_d_primes_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
%xlabel('ITD (us)')
xlabel('Natural ILD (deg)')
...
p1 = errorbar(1:2:8,mean(all_lead_hit_rates_collapsed(1:2:8,:),2),std(all_lead_hit_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r');
p2 = errorbar(2:2:8,mean(all_lead_hit_rates_collapsed(2:2:8,:),2),std(all_lead_hit_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b');
ylim([0 1])
title('Hit Rate')
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
...
errorbar(1:2:8,mean(all_lag_hit_rates_collapsed(1:2:8,:),2),std(all_lag_hit_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r')
errorbar(2:2:8,mean(all_lag_hit_rates_collapsed(2:2:8,:),2),std(all_lag_hit_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b')
ylim([0 1])
title('Hit Rate')
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
...
errorbar(1:2:8,mean(all_lead_FA_rates_collapsed(1:2:8,:),2),std(all_lead_FA_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r')
errorbar(2:2:8,mean(all_lead_FA_rates_collapsed(2:2:8,:),2),std(all_lead_FA_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b')
ylim([0 1])
title('FA Rate')
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
...
errorbar(1:2:8,mean(all_lag_FA_rates_collapsed(1:2:8,:),2),std(all_lag_FA_rates_collapsed(1:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','r','MarkerFaceColor','r')
errorbar(2:2:8,mean(all_lag_FA_rates_collapsed(2:2:8,:),2),std(all_lag_FA_rates_collapsed(2:2:8,:),[],2)/(sqrt(size(subject_ID,1))-1),'o','Color','b','MarkerFaceColor','b')
ylim([0 1])
xticks(1:8)
xticklabels({'5deg','5degMag','10deg','10degMag','5degLPF','5degMagLPF','10degLPF','10degMagLPF'})
%xlabel('ITD (us)')
