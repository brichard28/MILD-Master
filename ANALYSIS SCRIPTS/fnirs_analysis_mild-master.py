...
for ii, subject_num in enumerate(range(n_subjects)):
    ...
    n_conditions = 4
    conditions = ['itd=50_az=0_mag=0','itd=500_az=0_mag=0','itd=0_az=5_mag=0','itd=0_az=5_mag=0']
    ...
    data_ild5deg_avg = np.full((len(chan_indices_good), n_timepoints), np.nan)
    data_ild5degMag_avg = np.full((len(chan_indices_good), n_timepoints), np.nan)
    ...
    data_ild5deg_avg_hbr= np.full((len(chan_indices_good), n_timepoints), np.nan)
    ...
    subject_data_ild5deg[ii, chan_indices_good, :] = 1e6*data_ild5deg_avg.copy()
    subject_data_ild5degMag[ii, chan_indices_good, :] = 1e6*data_ild5degMag_avg.copy()
    ...
    subject_data_ild5deg_hbr[ii, chan_indices_good, :] = 1e6*data_ild5deg_avg_hbr.copy()
    subject_data_ild5degMag_hbr[ii, chan_indices_good, :] = 1e6*data_ild5degMag_avg_hbr.copy()
    ...
    # # put into a larger array with all subjects data!
    subject_data_itd50_GLM[ii, chan_indices_good] = glm_est_df.loc[glm_est_df['Condition'] == 'itd=50_az=0_mag=0']['theta']
    subject_data_itd500_GLM[ii, chan_indices_good] = glm_est_df.loc[glm_est_df['Condition'] == 'itd=500_az=0_mag=0']['theta']
    subject_data_ild5deg_GLM[ii, chan_indices_good] = glm_est_df.loc[glm_est_df['Condition'] == 'itd=0_az=5_mag=0']['theta']
    subject_data_ild5degMag_GLM[ii, chan_indices_good] = glm_est_df.loc[glm_est_df['Condition'] == 'itd=0_az=5_mag=1']['theta']
