 ...
 *
 **/
jsPsych.plugins["ben-multi-button-response"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('ben-multi-button-response', 'stimulus', 'audio');

	plugin.info = {
		name: 'ben-multi-button-response',
		description: '',
		parameters: {
			stimulus: {
      ...
      enable_buttons_after_audio: {
        ...
        default: false, // BNR added 10-28-2024
      ...
      trial_ends_after_audio: {
        ...
        default: true, // BNR added 10-28-2024
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // store response
    var response = {
      rt: array(), // BNR added 10-28-2024
      button: array() // BNR added 10-28-2024
    };
    ...
    function after_response(choice) {
      ...
      var this_rt = end_time - start_time;
      response.button = response.button.push(choice); // BNR added 10-28-2024
      response.rt = response.rt.push(this_rt); // BNR added 10-28-2024
