...
def main(subjectID):
    ...
    variables = {
        "side":      ['l',    'l',      'r',      'l',      'r',      'l',      'r',      'l',      'r',      'l',      'r',      ],
        "itd":       ['0',    '500',    '500',    '0',      '0',      '0',      '0',      '0',      '0',      '0',      '0',      ],
        "az":        ['0',    '0',      '0',      '10',     '10',     '10',     '10',     '30',     '30',     '30',     '30',     ],
        "mag":       ['0',    '0',      '0',      '0',      '0',      '1',      '1',      '0',      '0',      '1',      '1',      ],
                }
    ...
    fs = 44100          # fs
    n = 45              # # of trials
    ntokens = 5         # # of tokens in a trial
    snr = 0
    t_path = './stim/badaga'
    m_path = './stim/badaga'
    ...
    tm_delay = .3      # Delay between target start and masker start. Has been effectively zero <= nirs-im-8
    tt_delay = .25     # Delay between target end and next target start.
 ...
 tt_delay             |______|
    ...
    for condition in conditions:
        ...
        for k in np.arange(n):
            ...
            t_inds = np.random.randint(len(t_s), size=ntokens)
            while True:
            ...
            if levels['side'] == 'r':
                t_str = f"{k}_{this_sf_path_out_sub},Masker,"
                m_str = f"{k}_{this_sf_path_out_sub},Target,"
            else:
                t_str = f"{k}_{this_sf_path_out_sub},Target,"
                m_str = f"{k}_{this_sf_path_out_sub},Masker,"
